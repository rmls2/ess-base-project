...
Given the ReviewService register a nonexistent review with the user "Jorge Francisco" attraction "template" quality "5" and price "5" fields being mandatory
When a POST request is sent to /register with the user "Jorge Francisco" attraction "template" the quality "5" and price "4"
Then the response status should be "200"
And the JSON of the response must be "Review criada"

Scenario: Creation of review unsuccessfully
Given the ReviewService does not register a review with the user "Jorge Francisco" attraction "template" quality "5" 
When a POST request is sent to /register with the user "Jorge Francisco" attraction "template" quality "5"
...
Given the ReviewService update a existing review with user "Jorge Francisco" attraction "template" newQuality "5" and/or newPrice "5"
